...
namespace ZeroUI.Wpf.Editors
{
    ...
    public class MaskedTextBox : TextBox
    {
        ...
        public static readonly DependencyProperty RawTextProperty =
            DependencyProperty.Register(nameof(RawText), typeof(string), typeof(MaskedTextBox),
        ...
        public static readonly DependencyProperty IsMaskCompletedProperty =
            DependencyProperty.Register(nameof(IsMaskCompleted), typeof(bool), typeof(MaskedTextBox),
                new FrameworkPropertyMetadata(false));

        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register(nameof(CornerRadius), typeof(CornerRadius), typeof(MaskedTextBox),
        ...
        {
            if (d is MaskedTextBox box && box._engine != null)
            {
        ...
        {
            if (d is MaskedTextBox box && !box._isInternalUpdate && box._engine != null)
            {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="MaskedTextBox"/>.
    /// </summary>
    [Obsolete("ZeroMaskedTextBox is deprecated. Use MaskedTextBox instead.")]
    public class ZeroMaskedTextBox : MaskedTextBox
    {
    }
}
