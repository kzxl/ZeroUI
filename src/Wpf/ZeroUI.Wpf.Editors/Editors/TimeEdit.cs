...
namespace ZeroUI.Wpf.Editors
{
    ...
    /// </summary>
    public class TimeEdit : FrameworkElement
    {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(nameof(Value), typeof(TimeSpan), typeof(TimeEdit),
        ...
        public static readonly DependencyProperty ShowSecondsProperty =
            DependencyProperty.Register(nameof(ShowSeconds), typeof(bool), typeof(TimeEdit),
