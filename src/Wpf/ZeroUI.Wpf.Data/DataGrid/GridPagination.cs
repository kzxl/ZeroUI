...
namespace ZeroUI.Wpf.DataGrid
{
    ...
    /// </summary>
    public class GridPagination : Border
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="GridPagination"/>.
    /// </summary>
    [Obsolete("ZeroGridPagination is deprecated. Use GridPagination instead.")]
