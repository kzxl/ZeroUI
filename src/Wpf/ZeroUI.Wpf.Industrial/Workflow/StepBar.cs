...
namespace ZeroUI.Wpf.Workflow
{
    ...
    /// </summary>
    public class StepBar : FrameworkElement
    {
        ...
        public static readonly DependencyProperty CurrentIndexProperty =
            DependencyProperty.Register(nameof(CurrentIndex), typeof(int), typeof(StepBar),
        ...
        public static readonly DependencyProperty NodeSizeProperty =
            DependencyProperty.Register(nameof(NodeSize), typeof(double), typeof(StepBar),
        ...
        public static readonly DependencyProperty AllowClickToNavigateProperty =
            DependencyProperty.Register(nameof(AllowClickToNavigate), typeof(bool), typeof(StepBar),
                new FrameworkPropertyMetadata(true));

        private static void OnCurrentIndexChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is StepBar bar && e.NewValue is int idx)
            {
...
#pragma warning restore CS0618
    ...
    /// </summary>
    [Obsolete("ZeroStepBar is deprecated. Use StepBar instead.")]
