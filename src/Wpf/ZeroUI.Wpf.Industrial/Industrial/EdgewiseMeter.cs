...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class EdgewiseMeter : FrameworkElement, IScadaBindable
    {
        #region Dependency Properties

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(nameof(Value), typeof(double), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(65.4, FrameworkPropertyMetadataOptions.AffectsRender, null, CoerceValue));

        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(100.0, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register(nameof(Orientation), typeof(EdgewiseOrientation), typeof(EdgewiseMeter),
        ...
        public static readonly DependencyProperty PointerStyleProperty =
            DependencyProperty.Register(nameof(PointerStyle), typeof(EdgewisePointerStyle), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(EdgewisePointerStyle.Flag, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata("PRESSURE", FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty UnitProperty =
            DependencyProperty.Register(nameof(Unit), typeof(string), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata("bar", FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty DecimalPlacesProperty =
            DependencyProperty.Register(nameof(DecimalPlaces), typeof(int), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(1, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty HighAlarmThresholdProperty =
            DependencyProperty.Register(nameof(HighAlarmThreshold), typeof(double), typeof(EdgewiseMeter),
        ...
        public static readonly DependencyProperty LowAlarmThresholdProperty =
            DependencyProperty.Register(nameof(LowAlarmThreshold), typeof(double), typeof(EdgewiseMeter),
        ...
        public static readonly DependencyProperty CautionThresholdProperty =
            DependencyProperty.Register(nameof(CautionThreshold), typeof(double), typeof(EdgewiseMeter),
        ...
        public static readonly DependencyProperty ShowAlarmZonesProperty =
            DependencyProperty.Register(nameof(ShowAlarmZones), typeof(bool), typeof(EdgewiseMeter),
                new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty BarColorProperty =
            DependencyProperty.Register(nameof(BarColor), typeof(Color), typeof(EdgewiseMeter),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(EdgewiseMeter),
        ...
        static EdgewiseMeter()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(EdgewiseMeter), new FrameworkPropertyMetadata(typeof(EdgewiseMeter)));
        }

        public EdgewiseMeter()
        {
            Width = 72;
            Height = 240;
        }
        ...
        {
            if (d is EdgewiseMeter meter && baseValue is double v)
            {
