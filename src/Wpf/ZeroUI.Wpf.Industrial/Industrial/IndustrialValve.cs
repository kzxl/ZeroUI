...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class IndustrialValve : FrameworkElement, IScadaBindable
    {
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register(nameof(State), typeof(ValveState), typeof(IndustrialValve),
        ...
        public static readonly DependencyProperty StatusFlagsProperty =
            DependencyProperty.Register(nameof(StatusFlags), typeof(DeviceStatusFlags), typeof(IndustrialValve),
        ...
        public static readonly DependencyProperty OpeningPercentProperty =
            DependencyProperty.Register(nameof(OpeningPercent), typeof(double), typeof(IndustrialValve),
                new FrameworkPropertyMetadata(100.0, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty TagLabelProperty =
            DependencyProperty.Register(nameof(TagLabel), typeof(string), typeof(IndustrialValve),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(IndustrialValve),
