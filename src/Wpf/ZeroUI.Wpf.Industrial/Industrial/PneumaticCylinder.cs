...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class PneumaticCylinder : FrameworkElement, IScadaBindable
    {
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register(nameof(State), typeof(CylinderState), typeof(PneumaticCylinder),
        ...
        public static readonly DependencyProperty ExtensionPercentProperty =
            DependencyProperty.Register(nameof(ExtensionPercent), typeof(double), typeof(PneumaticCylinder),
        ...
        public static readonly DependencyProperty TagLabelProperty =
            DependencyProperty.Register(nameof(TagLabel), typeof(string), typeof(PneumaticCylinder),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(PneumaticCylinder),
