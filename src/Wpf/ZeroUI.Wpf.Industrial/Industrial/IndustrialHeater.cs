...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class IndustrialHeater : FrameworkElement, IScadaBindable
    {
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register(nameof(State), typeof(HeaterState), typeof(IndustrialHeater),
        ...
        public static readonly DependencyProperty TemperatureCProperty =
            DependencyProperty.Register(nameof(TemperatureC), typeof(double), typeof(IndustrialHeater),
        ...
        public static readonly DependencyProperty SetpointCProperty =
            DependencyProperty.Register(nameof(SetpointC), typeof(double), typeof(IndustrialHeater),
        ...
        public static readonly DependencyProperty HighAlarmCProperty =
            DependencyProperty.Register(nameof(HighAlarmC), typeof(double), typeof(IndustrialHeater),
        ...
        public static readonly DependencyProperty TagLabelProperty =
            DependencyProperty.Register(nameof(TagLabel), typeof(string), typeof(IndustrialHeater),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(IndustrialHeater),
        ...
        {
            if (d is IndustrialHeater heater)
            {
