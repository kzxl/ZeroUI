...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class AlarmBannerControl : FrameworkElement
    {
        public static readonly DependencyProperty OperatorNameProperty =
            DependencyProperty.Register(nameof(OperatorName), typeof(string), typeof(AlarmBannerControl),
                new FrameworkPropertyMetadata("Operator"));

        public static readonly DependencyProperty IsSilencedProperty =
            DependencyProperty.Register(nameof(IsSilenced), typeof(bool), typeof(AlarmBannerControl),
        ...
        {
            if (d is AlarmBannerControl banner)
            {
