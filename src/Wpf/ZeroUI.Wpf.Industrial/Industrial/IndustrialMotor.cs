...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class IndustrialMotor : FrameworkElement, IScadaBindable
    {
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register(nameof(State), typeof(MotorState), typeof(IndustrialMotor),
        ...
        public static readonly DependencyProperty StatusFlagsProperty =
            DependencyProperty.Register(nameof(StatusFlags), typeof(DeviceStatusFlags), typeof(IndustrialMotor),
        ...
        public static readonly DependencyProperty SpeedRpmProperty =
            DependencyProperty.Register(nameof(SpeedRpm), typeof(double), typeof(IndustrialMotor),
        ...
        public static readonly DependencyProperty TorqueNmProperty =
            DependencyProperty.Register(nameof(TorqueNm), typeof(double), typeof(IndustrialMotor),
        ...
        public static readonly DependencyProperty TagLabelProperty =
            DependencyProperty.Register(nameof(TagLabel), typeof(string), typeof(IndustrialMotor),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(IndustrialMotor),
