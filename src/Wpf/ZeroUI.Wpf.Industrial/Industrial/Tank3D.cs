...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class Tank3D : FrameworkElement, IScadaBindable
    {
        public static readonly DependencyProperty LevelPercentProperty =
            DependencyProperty.Register(nameof(LevelPercent), typeof(double), typeof(Tank3D),
        ...
        public static readonly DependencyProperty TemperatureCProperty =
            DependencyProperty.Register(nameof(TemperatureC), typeof(double), typeof(Tank3D),
        ...
        public static readonly DependencyProperty PressureBarProperty =
            DependencyProperty.Register(nameof(PressureBar), typeof(double), typeof(Tank3D),
        ...
        public static readonly DependencyProperty CapacityLitersProperty =
            DependencyProperty.Register(nameof(CapacityLiters), typeof(double), typeof(Tank3D),
        ...
        public static readonly DependencyProperty MediumColorProperty =
            DependencyProperty.Register(nameof(MediumColor), typeof(Color), typeof(Tank3D),
        ...
        public static readonly DependencyProperty TagLabelProperty =
            DependencyProperty.Register(nameof(TagLabel), typeof(string), typeof(Tank3D),
        ...
        public static readonly DependencyProperty BoundTagPathProperty =
            DependencyProperty.Register(nameof(BoundTagPath), typeof(string), typeof(Tank3D),
