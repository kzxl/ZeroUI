...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class SignalScope : FrameworkElement
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="SignalScope"/>.
    /// </summary>
    [Obsolete("ZeroSignalScope is deprecated. Use SignalScope instead.")]
    public class ZeroSignalScope : SignalScope
    {
    }
}
