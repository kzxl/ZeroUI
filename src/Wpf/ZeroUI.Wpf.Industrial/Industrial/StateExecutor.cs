...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class StateExecutor : FrameworkElement
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="StateExecutor"/>.
    /// </summary>
    [Obsolete("ZeroStateExecutor is deprecated. Use StateExecutor instead.")]
    public class ZeroStateExecutor : StateExecutor
    {
    }
}
