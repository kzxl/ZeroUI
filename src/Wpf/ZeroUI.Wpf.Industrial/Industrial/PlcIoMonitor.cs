...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class PlcIoMonitor : FrameworkElement
    {
        public static readonly DependencyProperty DigitalInputsProperty =
            DependencyProperty.Register(nameof(DigitalInputs), typeof(ushort), typeof(PlcIoMonitor),
        ...
        public static readonly DependencyProperty DigitalOutputsProperty =
            DependencyProperty.Register(nameof(DigitalOutputs), typeof(ushort), typeof(PlcIoMonitor),
        ...
        public static readonly DependencyProperty AllowSimulationClickProperty =
            DependencyProperty.Register(nameof(AllowSimulationClick), typeof(bool), typeof(PlcIoMonitor),
