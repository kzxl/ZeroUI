...
{
    /// <summary>
    /// Specifies the visual arrangement of the spinner and text labels inside <see cref="ProgressPanel"/>.
    /// </summary>
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="ProgressPanel"/>.
    /// </summary>
    ...
    /// </summary>
    [Obsolete("Use ProgressPanel instead.")]
    public class ZeroProgressPanel : ProgressPanel { }
}
