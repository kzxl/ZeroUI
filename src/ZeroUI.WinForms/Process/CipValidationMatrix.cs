...
namespace ZeroUI.WinForms.Process
{
    ...
    public class CipValidationMatrix : ZeroVisualControlBase
    {
        ...
        protected override void OnDrawVisual(Graphics g, Rectangle bounds, ZeroThemePalette palette)
        {
            ...
            if (matrixW < 120 || mainHeight < 100) return;
        ...
        private void DrawHeader(Graphics g, Rectangle bounds, ZeroThemePalette palette)
        {
            ...
            {
                TextRenderer.DrawText(g, $"{_engine.SkidTag} — {_engine.CircuitTag} ({_engine.CurrentPhase})", fontTitle, new Point(bounds.X + 16, bounds.Y + 12), palette.TextPrimary);
                ...
                Rectangle badgeRect = new Rectangle(bounds.Right - 180, bounds.Y + 10, 164, 24);
