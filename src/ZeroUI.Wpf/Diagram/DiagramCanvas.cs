...
namespace ZeroUI.Wpf.Diagram
{
    ...
    /// </summary>
    public class DiagramCanvas : FrameworkElement
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="DiagramCanvas"/>.
    /// </summary>
    [Obsolete("ZeroDiagramCanvas is deprecated. Use DiagramCanvas instead.")]
    public class ZeroDiagramCanvas : DiagramCanvas
    {
    }
}
