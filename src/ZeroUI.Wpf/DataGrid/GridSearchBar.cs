...
namespace ZeroUI.Wpf.DataGrid
{
    ...
    /// </summary>
    public class GridSearchBar : Border
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="GridSearchBar"/>.
    /// </summary>
    [Obsolete("ZeroGridSearchBar is deprecated. Use GridSearchBar instead.")]
