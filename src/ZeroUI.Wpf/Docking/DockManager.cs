...
namespace ZeroUI.Wpf.Docking
{
    ...
    /// </summary>
    public class DockPanelControl : HeaderedContentControl
    {
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(DockPanelControl), new PropertyMetadata("Panel"));

        public static readonly DependencyProperty DockPositionProperty =
            DependencyProperty.Register(nameof(DockPosition), typeof(DockPosition), typeof(DockPanelControl), new PropertyMetadata(DockPosition.Document));
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="DockPanelControl"/>.
    /// </summary>
    [Obsolete("ZeroDockPanel is deprecated. Use DockPanelControl instead.")]
    ...
    {
        private readonly ObservableCollection<DockPanelControl> _panels = new ObservableCollection<DockPanelControl>();
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="DockManager"/>.
    /// </summary>
    [Obsolete("ZeroDockManager is deprecated. Use DockManager instead.")]
