...
namespace ZeroUI.Wpf.Warehouse
{
    ...
    /// </summary>
    public class InventoryCard : FrameworkElement
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="InventoryCard"/>.
    /// </summary>
    [Obsolete("ZeroInventoryCard is deprecated. Use InventoryCard instead.")]
