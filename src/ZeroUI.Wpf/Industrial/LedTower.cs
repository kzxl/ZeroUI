...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class LedTower : FrameworkElement
    {
        public static readonly DependencyProperty RedOnProperty =
            DependencyProperty.Register(nameof(RedOn), typeof(bool), typeof(LedTower), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty YellowOnProperty =
            DependencyProperty.Register(nameof(YellowOn), typeof(bool), typeof(LedTower), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty GreenOnProperty =
            DependencyProperty.Register(nameof(GreenOn), typeof(bool), typeof(LedTower), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty BlueOnProperty =
            DependencyProperty.Register(nameof(BlueOn), typeof(bool), typeof(LedTower), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty WhiteOnProperty =
            DependencyProperty.Register(nameof(WhiteOn), typeof(bool), typeof(LedTower), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsRender));
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="LedTower"/>.
    /// </summary>
    [Obsolete("ZeroLedTower is deprecated. Use LedTower instead.")]
