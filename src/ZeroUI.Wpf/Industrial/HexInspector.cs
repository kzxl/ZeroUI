...
namespace ZeroUI.Wpf.Industrial
{
    ...
    /// </summary>
    public class HexInspector : FrameworkElement
    {
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="HexInspector"/>.
    /// </summary>
    [Obsolete("ZeroHexInspector is deprecated. Use HexInspector instead.")]
    public class ZeroHexInspector : HexInspector
    {
    }
}
