...
namespace ZeroUI.Wpf.Editors
{
    ...
    /// </summary>
    public class TagControl : FrameworkElement
    {
        ...
        public static readonly DependencyProperty TagTypeProperty =
            DependencyProperty.Register(nameof(TagType), typeof(TagType), typeof(TagControl),
                new FrameworkPropertyMetadata(TagType.Default, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(TagControl),
        ...
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register(nameof(CornerRadius), typeof(double), typeof(TagControl),
        ...
        public static readonly DependencyProperty ClosableProperty =
            DependencyProperty.Register(nameof(Closable), typeof(bool), typeof(TagControl),
