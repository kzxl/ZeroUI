...
namespace ZeroUI.Wpf.Editors
{
    ...
    public class MemoEdit : TextBox
    {
        ...
        public static readonly DependencyProperty PlaceholderProperty =
            DependencyProperty.Register(nameof(Placeholder), typeof(string), typeof(MemoEdit),
                new FrameworkPropertyMetadata(string.Empty, FrameworkPropertyMetadataOptions.AffectsRender));

        public static readonly DependencyProperty ShowCharacterCountProperty =
            DependencyProperty.Register(nameof(ShowCharacterCount), typeof(bool), typeof(MemoEdit),
    ...
    /// <summary>
    /// Backward-compatibility alias for <see cref="MemoEdit"/>.
    /// </summary>
