...
namespace ZeroUI.WinForms.Editors
{
    ...
    public class ZPictureEdit : ControlBase
    {
    ...
    /// </summary>
    [Obsolete("PictureEdit is deprecated and will be removed in 5 release cycles. Please migrate to ZPictureEdit instead.")]
    [ToolboxItem(false)]
